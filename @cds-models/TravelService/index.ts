...
export function _TravelAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class Travel extends Base {
    ...
    */
    ...
    declare TravelStatus_code?: _sap_fe_cap_travel.TravelStatusCode | null
    ...
    declare static readonly actions: {
      createTravelByTemplate:  {
        // positional
        (): Travel
        // named
        ({}: globalThis.Record<never, never>): Travel
        // metadata (do not use)
        __parameters: globalThis.Record<never, never>, __returns: Travel, __self: Travel
        kind: 'action'
      }
      rejectTravel:  {
        // positional
        ...
        // metadata (do not use)
        __parameters: globalThis.Record<never, never>, __returns: any, __self: Travel
        kind: 'action'
      }
      acceptTravel:  {
        // positional
      ...
      deductDiscount:  {
        // positional
        (percent: _.Percentage): Travel
        // named
        ({percent}: {percent: _.Percentage}): Travel
        // metadata (do not use)
        __parameters: {percent: _.Percentage}, __returns: Travel, __self: Travel
        kind: 'action'
      }
    };
  };
...
export function _CurrencyAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class Currency extends Base {
    ...
    declare numcode?: number | null
    declare exponent?: number | null
    declare minor?: string | null
...
Object.defineProperty(Currency, 'name', { value: 'TravelService.Currencies' })
...
Object.defineProperty(Currencies, 'name', { value: 'TravelService.Currencies' })
...
export function _TravelStatuAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class TravelStatu extends Base {
    declare name?: string | null
    declare descr?: string | null
    declare code?: __.Key<_sap_fe_cap_travel.TravelStatusCode>
...
Object.defineProperty(TravelStatu, 'name', { value: 'TravelService.TravelStatus' })
Object.defineProperty(TravelStatu, 'is_singular', { value: true })
export class TravelStatus extends Array<TravelStatu> {$count?: number}
Object.defineProperty(TravelStatus, 'name', { value: 'TravelService.TravelStatus' })
...
Object.defineProperty(TravelAgency, 'name', { value: 'TravelService.TravelAgency' })
...
Object.defineProperty(TravelAgency_, 'name', { value: 'TravelService.TravelAgency' })
...
Object.defineProperty(Passenger, 'name', { value: 'TravelService.Passenger' })
Object.defineProperty(Passenger, 'is_singular', { value: true })
export class Passenger_ extends Array<Passenger> {$count?: number}
Object.defineProperty(Passenger_, 'name', { value: 'TravelService.Passenger' })
...
export function _BookingAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class Booking extends Base {
    ...
    */
    ...
    declare BookingStatus_code?: _sap_fe_cap_travel.BookingStatusCode | null
...
Object.defineProperty(Booking, 'name', { value: 'TravelService.Booking' })
Object.defineProperty(Booking, 'is_singular', { value: true })
export class Booking_ extends Array<Booking> {$count?: number}
Object.defineProperty(Booking_, 'name', { value: 'TravelService.Booking' })
...
Object.defineProperty(Country, 'name', { value: 'TravelService.Countries' })
...
Object.defineProperty(Countries, 'name', { value: 'TravelService.Countries' })
...
export function _BookingStatuAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class BookingStatu extends Base {
    declare name?: string | null
    declare descr?: string | null
    declare code?: __.Key<_sap_fe_cap_travel.BookingStatusCode>
...
Object.defineProperty(BookingStatu, 'name', { value: 'TravelService.BookingStatus' })
...
Object.defineProperty(BookingStatus, 'name', { value: 'TravelService.BookingStatus' })
...
Object.defineProperty(BookingSupplement, 'name', { value: 'TravelService.BookingSupplement' })
...
Object.defineProperty(BookingSupplement_, 'name', { value: 'TravelService.BookingSupplement' })
...
Object.defineProperty(Airline, 'name', { value: 'TravelService.Airline' })
Object.defineProperty(Airline, 'is_singular', { value: true })
export class Airline_ extends Array<Airline> {$count?: number}
Object.defineProperty(Airline_, 'name', { value: 'TravelService.Airline' })
...
Object.defineProperty(Flight, 'name', { value: 'TravelService.Flight' })
Object.defineProperty(Flight, 'is_singular', { value: true })
export class Flight_ extends Array<Flight> {$count?: number}
Object.defineProperty(Flight_, 'name', { value: 'TravelService.Flight' })
...
Object.defineProperty(Supplement, 'name', { value: 'TravelService.Supplement' })
Object.defineProperty(Supplement, 'is_singular', { value: true })
export class Supplement_ extends Array<Supplement> {$count?: number}
Object.defineProperty(Supplement_, 'name', { value: 'TravelService.Supplement' })
...
Object.defineProperty(FlightConnection, 'name', { value: 'TravelService.FlightConnection' })
...
Object.defineProperty(FlightConnection_, 'name', { value: 'TravelService.FlightConnection' })
...
Object.defineProperty(SupplementType, 'name', { value: 'TravelService.SupplementType' })
...
Object.defineProperty(SupplementType_, 'name', { value: 'TravelService.SupplementType' })
...
Object.defineProperty(Airport, 'name', { value: 'TravelService.Airport' })
Object.defineProperty(Airport, 'is_singular', { value: true })
export class Airport_ extends Array<Airport> {$count?: number}
Object.defineProperty(Airport_, 'name', { value: 'TravelService.Airport' })
...
export namespace Currencies {
  ...
  Object.defineProperty(text, 'name', { value: 'TravelService.Currencies.texts' })
  Object.defineProperty(text, 'is_singular', { value: true })
  export class texts extends Array<text> {$count?: number}
  Object.defineProperty(texts, 'name', { value: 'TravelService.Currencies.texts' })
...
export namespace TravelStatus {
  ...
  export class text extends _textAspect(__.Entity) {}
  Object.defineProperty(text, 'name', { value: 'TravelService.TravelStatus.texts' })
  Object.defineProperty(text, 'is_singular', { value: true })
  export class texts extends Array<text> {$count?: number}
  Object.defineProperty(texts, 'name', { value: 'TravelService.TravelStatus.texts' })
...
export namespace Countries {
  ...
  export class text extends _textAspect(__.Entity) {}
  Object.defineProperty(text, 'name', { value: 'TravelService.Countries.texts' })
  Object.defineProperty(text, 'is_singular', { value: true })
  export class texts extends Array<text> {$count?: number}
  Object.defineProperty(texts, 'name', { value: 'TravelService.Countries.texts' })
...
export namespace BookingStatus {
  ...
  export class text extends _textAspect(__.Entity) {}
  Object.defineProperty(text, 'name', { value: 'TravelService.BookingStatus.texts' })
  Object.defineProperty(text, 'is_singular', { value: true })
  export class texts extends Array<text> {$count?: number}
  Object.defineProperty(texts, 'name', { value: 'TravelService.BookingStatus.texts' })
...
export namespace Supplement {
  ...
  export class text extends _textAspect(__.Entity) {}
  Object.defineProperty(text, 'name', { value: 'TravelService.Supplement.texts' })
  Object.defineProperty(text, 'is_singular', { value: true })
  export class texts extends Array<text> {$count?: number}
  Object.defineProperty(texts, 'name', { value: 'TravelService.Supplement.texts' })
...
export namespace SupplementType {
  ...
  export class text extends _textAspect(__.Entity) {}
  Object.defineProperty(text, 'name', { value: 'TravelService.SupplementType.texts' })
  Object.defineProperty(text, 'is_singular', { value: true })
  export class texts extends Array<text> {$count?: number}
  Object.defineProperty(texts, 'name', { value: 'TravelService.SupplementType.texts' })
