...
export function _FlowHistoryAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class FlowHistory extends Base {
    declare transitions_?: __.Composition.of.many<Array<{   timestamp?: __.Key<__.DeepRequired<_.managed>['createdAt']>,   user?: __.DeepRequired<_.managed>['createdBy'] | null,   status?: string | null,   comment?: string | null, }>>
    static readonly kind: 'entity' | 'type' | 'aspect' = 'aspect';
